<template>
    <div :class="expanded ? 'fixed inset-0 z-[100]' : ''">
        <!-- Overlay -->
        <div v-if="expanded" class="fixed inset-0 z-0 bg-slate-900/40 backdrop-blur-md" aria-hidden="true"
            @click="expanded = false" />
        <!-- Card: normal o flotante -->
        <div class="  rounded-2xl transition-all duration-200" :class="[
            expanded
            ...
            <div class="w-full flex-1 min-h-0 rounded-lg"
