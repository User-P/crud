<template>
    ...
    >
        <div class="space-y-8">
            ...
            <div class="cosmos-surface rounded-xl px-4 py-3 text-sm text-amber-900 shadow-sm ring-1 ring-amber-200/50">
            ...
            <!-- Leyenda de riesgo -->
            <div class="cosmos-surface flex flex-wrap gap-6 rounded-xl px-5 py-4 shadow-sm">
