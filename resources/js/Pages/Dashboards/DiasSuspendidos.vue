<template>
    <AdminLayout :breadcrumbs="[
        ...
        <div class="space-y-8">
            <DashboardHeader title="Días usuarios suspendidos" subtitle="Semáforo de riesgo por tiempo de suspensión"
            ...
            <div class="  rounded-xl px-4 py-3 text-sm text-amber-900 shadow-sm ring-1 ring-amber-200/50">
            ...
            <!-- Leyenda de riesgo -->
            <div class="  flex flex-wrap gap-6 rounded-xl px-5 py-4 shadow-sm">
