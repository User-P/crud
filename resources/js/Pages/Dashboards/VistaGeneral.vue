                ...
                <section>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div
                                    class="drag-handle flex h-6 w-6 cursor-grab select-none items-center justify-center rounded-md text-(--th-text-muted) opacity-50 transition-opacity duration-200 hover:opacity-90 group-hover/tile:opacity-70 active:cursor-grabbing"
                            ...
                            <button
                                type="button"
                                class="secondary-metric-tile group relative flex w-full flex-col overflow-hidden rounded-2xl p-4 pl-5 text-left transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-(--p-focus-ring-color) focus:ring-offset-2 focus:ring-offset-(--th-ring-offset)"
