<template>
    <div class="space-y-4">
        ...
        <div v-if="tableApi" class="rounded-lg border border-gray-200/80 bg-white p-4 shadow-sm">
            <div class="flex flex-col gap-3">
                <div class="flex flex-wrap items-center justify-between gap-2">
                    <div class="text-sm font-medium text-gray-700">Filtros y búsqueda</div>
        ...
        <div class="flex justify-end mb-2">
            <InputText v-model="globalSearch" type="search" class="w-full min-w-[12rem] sm:w-52 lg:w-64 text-sm p-2"
                placeholder="Buscar..." />
        </div>
