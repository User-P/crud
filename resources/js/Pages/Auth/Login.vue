                    ...
                    <form class="space-y-5" @submit.prevent="submit">
                        <div>
                            ...
                            <span class="p-input-icon-left w-full mt-2">
                                ...
                                <InputText id="email" v-model="form.email" type="email" class="w-full"
                                    autocomplete="username" :invalid="Boolean(form.errors.email)"
                        ...
                        <div>
                            ...
                            <Password id="password" v-model="form.password" class="w-full mt-2" toggleMask
                                :feedback="false" inputClass="w-full" :invalid="Boolean(form.errors.password)"
                                placeholder="••••••••" />
                        ...
                        <Button type="submit" :loading="form.processing" label="Iniciar sesión" icon="pi pi-sign-in"
